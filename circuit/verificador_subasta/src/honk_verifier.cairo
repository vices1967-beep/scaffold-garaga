...
use super::honk_verifier_circuits::{
    ...
    run_BN254_EVAL_FN_CHALLENGE_DUPL_47P_RLC_circuit,
};
...
mod UltraKeccakHonkVerifier {
    ...
    use super::{
        vk, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_10_PUB_1_circuit,
        run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_10_circuit,
        run_BN254_EVAL_FN_CHALLENGE_DUPL_47P_RLC_circuit,
    };
    ...
    impl IUltraKeccakHonkVerifier of super::IUltraKeccakHonkVerifier<ContractState> {
        fn verify_ultra_keccak_honk_proof(
            ...
            let (zk_ecip_batched_lhs) = run_BN254_EVAL_FN_CHALLENGE_DUPL_47P_RLC_circuit(
                A0: random_point,
